...
def tutorial_dialog():
    ...
    st.write("O **🏠 Início** funciona como um painel único. No topo, **💰 Meu mês** reúne o alerta financeiro e os seis números principais: disponível, entradas, gastos, contas a pagar, valor para guardar e atrasos. Em **⚡ Ações rápidas**, registre receita, gasto ou conta sem procurar no menu. Logo abaixo ficam **Movimentações recentes**, o gráfico **Para onde foi meu dinheiro?** e **📅 Contas e compromissos**, onde continua disponível o botão **Paguei**.")
