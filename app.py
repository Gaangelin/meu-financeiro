...
def tutorial_dialog():
    ...
    st.write("Em **🏠 Início**, acompanhe saldo disponível, próximo pagamento, quanto guardar e o limite seguro por dia. Em **📂 Meus compromissos**, os itens ficam em ordem de vencimento e recebem sinais simples: **🔴 atrasado**, **🟠 vence hoje**, **🟡 vence em até 3 dias** e **🔵 próximo vencimento**. Você pode marcar **Paguei** diretamente no Início. A área **🔔 Próximos vencimentos** continua reunindo os compromissos pendentes com mais detalhes.")
