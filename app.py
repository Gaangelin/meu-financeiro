...
def tutorial_dialog():
    ...
    st.write("O **🏠 Início** funciona como um painel único. No topo, **💰 Meu mês** reúne o alerta financeiro e os seis números principais: disponível, entradas, gastos, contas a pagar, valor para guardar e atrasos. Logo abaixo aparecem também **Próximo pagamento** e **Limite seguro por dia**, sem repetir os indicadores no final da página. Em **⚡ Ações rápidas**, registre receita, gasto ou conta sem procurar no menu. Depois ficam **Movimentações recentes**, o gráfico **Para onde foi meu dinheiro?** e **📅 Contas e compromissos**, onde continua disponível o botão **Paguei**.")
...
if page=="🏠 Início":
    ...
    apoio1,apoio2=st.columns(2)
    apoio1.info(f"🗓️ **Próximo pagamento:** {money(nv)}")
    apoio2.info(f"📈 **Limite seguro por dia:** {money(diario)}")
