...
page=st.sidebar.radio("Menu",["🏠 Início","🏦 Bancos","🤖 Assistente IA","🚦 Saúde Financeira","📉 Dívidas","🎯 Metas","⚙️ Configurações"])
...
if page=="🏠 Início":
    ...
    if acao_simples=="recebi":
        st.success("Use **➕ Registrar** e escolha uma entrada. O formulário completo continua disponível para você registrar o valor com segurança.")
    elif acao_simples=="gastei":
        st.info("Use **➕ Registrar** para lançar o gasto. Depois o Meu Financeiro inclui esse valor automaticamente nos seus cálculos.")
    elif acao_simples=="conta":
        st.info("Use **🧾 Contas** para cadastrar o valor e o vencimento. Assim ela aparece nos próximos vencimentos.")
