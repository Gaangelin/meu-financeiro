...
if page=="🏠 Início":
    ...
    st.caption("Veja o que precisa pagar agora e o que já está programado para os próximos meses.")
    ...
    if parc_home_fut:
        ...
        st.caption("Parcelas já pagas neste mês que continuam nos próximos meses. Aqui é só para acompanhar — não há pagamento antecipado.")
        for x in parc_home_fut[:5]:
            ...
            st.info(f"💳 **{nome_fut}** · próxima **{prox_fut}/{total_fut}** · {money(valor_fut)} · vence dia {dia_fut} do próximo mês")
