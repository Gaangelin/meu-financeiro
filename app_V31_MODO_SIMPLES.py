...
def tutorial_dialog():
    ...
    st.write("Na tela **🏠 Início**, os atalhos **Recebi dinheiro**, **Gastei dinheiro**, **Tenho uma conta** e **Posso comprar?** ajudam usuários iniciantes a encontrar rapidamente a função certa, sem precisar conhecer termos financeiros.")
...
if page=="🏠 Início":
    ...
    if acao_simples=="recebi":
        ...
        st.info("O simulador **Posso comprar?** será a próxima evolução do Modo Simples: ele vai testar uma compra antes de você assumir o gasto.")
